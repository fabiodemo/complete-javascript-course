...
// const month = `${now.getMonth() + 1}`.padStart(2, 0); //getMonth is from 0 to 11
...
btnLogin.addEventListener('click', function (e) {
  ...
  if (currentAccount?.pin === +inputLoginPin.value) {
    ...
    // Experimenting with the API Intl
    const now = new Date();
    const options = {
      hour: 'numeric',
      minute: 'numeric',
...
// setInterval -> keep running forever until we stop it

// SetTimeOut
// Stopping timer with cleatimeout
